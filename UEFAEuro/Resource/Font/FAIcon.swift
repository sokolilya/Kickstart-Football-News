...
//
//    func setRightViewFAIcon(icon: FAType, rightViewMode: UITextFieldViewMode = .always, orientation: UIImageOrientation = UIImageOrientation.down, textColor: UIColor = .black, backgroundColor: UIColor = .clear, size: CGSize? = nil) {
...
//            let iconAttributes = [NSAttributedString.Key.font: iconFont, NSAttributedString.Key.foregroundColor: textColor] as [NSAttributedString.Key : Any]
//
...
//     */
//    public func setFAIconWithName(icon: FAType, textColor: UIColor, orientation: UIImage.Orientation = UIImageOrientation.down, backgroundColor: UIColor = UIColor.clear, size: CGSize? = nil) {
//        FontLoader.loadFontIfNeeded()
...
//
//    public func setFAIcon(icon: FAType, size: CGSize? = nil, orientation: UIImage.Orientation = UIImageOrientation.down, textColor: UIColor = UIColor.black, backgroundColor: UIColor = UIColor.clear, selectedTextColor: UIColor = UIColor.black, selectedBackgroundColor: UIColor = UIColor.clear) {
//        FontLoader.loadFontIfNeeded()
//        let tabBarItemImageSize = size ?? CGSize(width: 30, height: 30)
//
//        image = UIImage(icon: icon, size: tabBarItemImageSize, orientation: orientation, textColor: textColor, backgroundColor: backgroundColor).withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
//
//        selectedImage = UIImage(icon: icon, size: tabBarItemImageSize, orientation: orientation, textColor: selectedTextColor, backgroundColor: selectedBackgroundColor).withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
//
...
//        assert(font != nil, FAStruct.ErrorAnnounce)
//        let attributes = [NSAttributedString.Key.font: font!, NSAttributedString.Key.foregroundColor: textColor, NSAttributedString.Key.backgroundColor: backgroundColor, NSAttributedStringKey.paragraphStyle: paragraph]
//
